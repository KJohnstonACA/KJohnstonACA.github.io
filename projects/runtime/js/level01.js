var level01 = function (window) {
    ...
    window.opspark.runLevelInGame = function (game) {
        ...
        //     createTiger(levelData.gameItems[i].x, levelData.gameItems[i].y)
        // };
        for (var i = 0; i < levelData.gameItems.length; i++) {
            ...
            } else if (gameItems.type === "tiger") {
                createTiger(gameItems.x, gameItems.y);
